...
A total of 1,139 high-resolution images ranging from 1920x1080 to 4096x3072 pixels of Medaka fish (\textit{Oryzias} species) were gathered from both primary and secondary sources. Then the Medaka fish in these images were annotated using Roboflow, resulting in a total of 1,280 labeled instances: 641 of \textit{Oryzias celebensis} and 639 of \textit{Oryzias javanicus}. Figure \ref{fig:dataset_hybrid} shows the examples of annotated Medaka images from our dataset.
...
As illustrated in Figure \ref{fig:data_acquisition_strategies}, after both of raw images and raw photos were collected, we then filtered the images based on the file size and the image PSNR.
