...
Our final dataset comprises 1,139 unique images containing 1,280 annotated Medaka (\textit{Oryzias}) instances, systematically acquired through a dual-source methodology. The dataset encompasses two endemic Indonesian species of conservation value: \textit{Oryzias celebensis} (n=641 instances) and \textit{Oryzias javanicus} (n=639 instances), a near-balanced distribution that supports unbiased model learning of inter-species differences.
